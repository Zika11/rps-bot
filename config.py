...
RATING_TIERS = [
    ...
    (1200, 1399, "ذهبي", "🥇"), (1400, 1599, "بلاتينيوم", "🔮"),
    (1600, 1799, "ماسي", "💎"), (1800, 9999, "أسطورة", "👑")
]
def get_tier_info(rating):
    for low, high, name, icon in RATING_TIERS:
        if low <= rating <= high: return name, icon
    return "غير مصنف", "❓"
...
BATTLE_PASS_REWARDS = {
    ...
    5:{"free":("treasure_box",None),"premium":("gems",10)}, 6:{"free":("points",120),"premium":("title","مخضرم")},
    7:{"free":("gems",5),"premium":("booster","shield_1h")}, 8:{"free":("points",150),"premium":("theme","theme_2")},
    9:{"free":("treasure_box",None),"premium":("gems",15)}, 10:{"free":("points",200),"premium":("title","أسطورة الموسم")}
}
